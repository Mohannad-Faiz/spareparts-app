...
const i18n = {
  ...
  en: {
    ...
    brand_warehouses: 'Warehouses',
    page_title: 'Access Lion Warehouses | Inventory & QR System',
    login_title: 'Access Lion Warehouses',
    login_subtitle: 'Access Lion Warehouses - Spare Parts & QR Code Management',
    splash_skip_hint: 'Click to skip • انقر للتخطي',
    username: 'Username',
    password: 'Password',
    login_button: 'Sign In',
    demo_creds_label: 'Quick Demo Credentials:',
    ...
    // Top bar
    search_placeholder: 'Quick search by Part #, Name, Brand, Model, Location...',
    btn_quick_scan: 'Quick QR Scan',
    btn_quick_add: 'Add Part',

    // Stats
    stat_total_parts: 'Total Part Types',
    stat_total_stock: 'Total Quantity in Stock',
    stat_low_stock: 'Low Stock Alerts',
    stat_categories: 'Categories & Locations',
    categories_suffix: 'categories',

    // Inventory Tab
    inventory_title: 'Spare Parts Catalog & Inventory',
    inventory_subtitle: 'Explore, filter, print QR labels, and manage warehouse inventory',
    filter_all_categories: 'All Categories',
    filter_all_brands: 'All Brands',
    filter_low_stock_btn: 'Low Stock Items Only',
    th_qr: 'QR Code',
    ...
    th_actions: 'Actions',
    empty_parts_title: 'No parts matched your search',
    empty_parts_desc: 'Try adjusting your search criteria or add a new spare part to inventory.',
    empty_parts_btn: 'Add Part Now',
    action_print_qr: 'Print QR',
    action_edit: 'Edit',
    action_delete: 'Disable',
    not_specified: 'Not specified',

    // Add Part Tab
    add_part_title: 'Add New Spare Part',
    add_part_subtitle: 'Automatically generates Part Number and creates unique QR code in database',
    form_part_num: 'Part Number',
    form_part_num_hint: '(Leave blank for auto-generation e.g. SP-000126)',
    btn_generate: 'Generate',
    form_part_name: 'Part Name',
    form_category: 'Category',
    form_brand: 'Brand / Manufacturer',
    form_model: 'Model / Compatibility',
    form_location: 'Storage Location (Rack/Shelf/Bin)',
    form_quantity: 'Initial Quantity',
    form_min_stock: 'Minimum Stock Level',
    form_unit: 'Unit of Measurement',
    form_supplier: 'Supplier',
    form_desc: 'Technical Description & Specs',
    form_notes: 'Internal Notes',
    btn_save_part: 'Save & Generate QR Code',
    btn_reset_form: 'Reset Fields',

    // Units
    unit_pcs: 'Pieces (pcs)',
    unit_set: 'Set (set)',
    unit_box: 'Box (box)',
    unit_liter: 'Liter (liter)',
    unit_meter: 'Meter (meter)',
    unit_kg: 'Kilogram (kg)',
    unit_pair: 'Pair (pair)',

    // QR Scanner Tab
    scanner_title: 'Scan QR Code via Camera',
    scanner_subtitle: 'Point phone or computer camera at QR sticker for instant identification',
    btn_start_camera: 'Start Camera',
    btn_stop_camera: 'Stop Camera',
    scanner_divider: 'Or Manual / Simulated Barcode Scan Input',
    manual_scan_label: 'Scanned QR Raw Payload:',
    btn_lookup: 'Lookup',
    quick_test_hint: 'Try 1-click simulated scan with these parts:',
    no_parts_to_test: 'No parts available for quick test',
    scan_result_title: 'Scan & Verification Result',
    scan_result_subtitle: 'Real-time inventory lookup data',
    scan_waiting_title: 'Waiting for QR Code scan...',
    scan_waiting_desc: 'Point camera at any label or click one of the quick test buttons above.',
    scan_in_stock: '✅ In Stock',
    scan_low_stock_warning: '⚠️ Low Stock Warning',
    scan_matched_location: 'Warehouse Location',
    scan_matched_cat_brand: 'Category & Brand',
    scan_matched_model: 'Compatible Model',
    scan_matched_min_stock: 'Safety Stock / Reorder Level',
    scan_matched_supplier_desc: 'Supplier & Specs',

    // Actions on scanned part
    action_add_stock_btn: '+ Add Stock',
    action_issue_stock_btn: '- Issue / Take',
    action_view_history_btn: 'View History',
    action_edit_part_btn: 'Edit Part',
    action_print_label_btn: 'Print Label',

    // Stock Modals
    modal_add_stock_title: '+ Add / Receive Stock',
    form_qty_to_add: 'Quantity to Add',
    form_po_number: 'Purchase Order # (PO #)',
    form_invoice_number: 'Invoice #',
    btn_confirm_add_stock: 'Confirm Stock Addition',
    
    modal_issue_stock_title: '- Issue / Take Stock',
    form_qty_to_issue: 'Quantity to Issue',
    form_issued_to: 'Recipient (Technician / Driver / Employee)',
    form_vehicle_equip: 'Vehicle / Equipment #',
    form_dept_project: 'Department / Project',
    form_work_order: 'Work Order #',
    form_reason_issue: 'Reason for Issue',
    btn_confirm_issue_stock: 'Confirm Stock Issue',

    modal_history_title: 'Part Transaction & Movement History',
    th_trans_type: 'Type',
    ...
    stat_total_devices: 'Total Scanners',
    stat_active_devices: 'Active Scanners',
    stat_total_device_scans: 'Total Device Scans',
    stat_speed_mode: 'Instant Capture Engine',
    stat_speed_value: '< 40ms Active',
    devices_title: 'QR & Barcode Scanner Hardware Management',
    devices_subtitle: 'Pair, calibrate, and manage wireless USB/Bluetooth HID scanners, serial ports & fixed cameras',
    btn_add_device: '+ Add New Scanner',
    empty_devices_title: 'No scanner devices registered yet',
    empty_devices_desc: 'Add a handheld wireless/USB scanner or fixed camera to enable instant barcode capture & stock routing.',
    calibration_title: 'Live Scanner Calibration & Test Pad',
    calibration_subtitle: 'Benchmark scanner response time (Latency ms) and verify audio-visual feedback in real time',
    test_station_live: 'Station Ready & Listening',
    select_device_to_test: 'Select device to calibrate:',
    scan_input_pad_label: 'Live hardware scan receptor pad (Point scanner & pull trigger):',
    btn_simulate_pulse: 'Simulate Pulse',
    hw_scanner_title: 'Wireless / USB Hardware QR Scanner',
    hw_scanner_desc: 'The system captures wireless scanner gun keystrokes globally in ultra-high speed without needing to focus on an input field.',
    active_device_select_label: 'Currently Active Device:',
    btn_manage_devices: 'Manage Devices',
    modal_add_device_title: 'Register New Scanner Device',
    modal_edit_device_title: 'Edit Scanner Device Settings',
    modal_test_device_title: 'Scanner Device Benchmark & Calibration',
    form_device_name: 'Device Name & Label',
    form_device_type: 'Device Type / Protocol',
    form_connection_port: 'Port / Identifier',
    form_device_location: 'Warehouse Location',
    form_default_action: 'Default Action on Scan',
    form_sound_feedback: 'Audio Feedback Profile',
    ...
    btn_done: 'Done & Finish Test',
    device_created_success: 'Scanner device registered and paired successfully!',
    device_updated_success: 'Scanner device settings updated successfully',
    device_deleted_success: 'Scanner device deactivated',
    device_test_success: 'Scanner hardware responding normally & calibrated',
    device_active_switched: 'Active scanner device switched to:',
    ...
    low_stock_orders_subtitle: 'Parts reaching or below safety stock - generate instant purchase order with technical specifications',
    btn_order_all_low_stock: 'Add All Low Stock Parts to New PO',
    th_suggested_qty: 'Suggested Order Qty',
    orders_history_title: 'Purchase Orders History & Tracking',
    orders_history_subtitle: 'Track order statuses, inventory receipts, and print official Purchase Orders with item specs',
    btn_create_new_order: '+ Create New Purchase Order',
    th_po_num: 'PO Number (PO #)',
    ...
    form_order_terms_notes: 'PO Terms, Technical Notes & Instructions',
    order_items_list_title: 'Items & Specifications in this Order',
    ...
    btn_save_and_generate_po: 'Save & Generate Purchase Order',
    btn_print_order_doc: 'Print Official Purchase Order',
    btn_receive_stock_to_inventory: '📦 Receive Stock into Inventory Automatically',
    btn_mark_ordered: 'Mark as Sent to Supplier',
    order_created_success: 'Purchase Order created and official document generated successfully!',
    order_status_updated_success: 'Order status updated successfully',
    order_received_success: 'Order confirmed as received and stock balances updated automatically!',
    order_deleted_success: 'Purchase Order deleted successfully',
    status_pending: 'Pending Approval',
    status_ordered: 'Sent to Supplier',
    status_received: 'Received & Stocked',
    status_cancelled: 'Cancelled',
    priority_normal: 'Normal',
    priority_high: 'High',
    priority_urgent: 'Urgent',
    no_low_stock_parts: 'Excellent! No parts are currently low on stock',
    no_orders_recorded: 'No purchase orders recorded yet. Click "+ Create New Purchase Order"',
    order_item_already_added: 'This part is already added in current order draft',

    // Print Labels Tab
    print_studio_title: 'QR Code Labels Studio',
    print_studio_subtitle: 'Generate high-resolution printable labels for thermal printers or A4 sheets',
    btn_print_all: 'Print All Displayed Labels',
    loading_labels: 'Loading QR cards for all parts...',
    no_labels: 'No parts available to print',
    stock_balance_label: 'Stock',

    // Audit Log Tab
    audit_title: 'Audit Log & Activity Trail',
    audit_subtitle: 'Tracks all sensitive system actions (logins, part creation, edits, deletions)',
    btn_refresh_audit: 'Refresh Log',
    th_audit_time: 'Timestamp',
    th_audit_user: 'User',
    th_audit_action: 'Action',
    th_audit_entity: 'Entity',
    th_audit_id: 'Entity ID',
    th_audit_details: 'Additional Details',
    no_audit_logs: 'No audit records yet',

    // Users Tab
    users_title: 'Users & Permissions Management',
    users_subtitle: 'Manage user accounts and role permissions (Admin, Storekeeper, Viewer)',
    btn_new_user: 'New User',
    th_user_name: 'Full Name',
    th_user_username: 'Username',
    th_user_email: 'Email',
    th_user_role: 'Role & Permission',
    th_user_status: 'Status',
    th_user_created: 'Created Date',
    status_active: 'Active',
    status_inactive: 'Inactive',

    // Modals
    modal_qr_title: 'Part QR Code Label',
    btn_print_label_now: 'Print Label Now',
    btn_download_qr: 'Download QR Image',
    modal_edit_part_title: 'Edit Spare Part Details',
    btn_save_changes: 'Save Changes',
    btn_cancel: 'Cancel',
    modal_add_user_title: 'Add New User to System',
    form_user_fullname: 'Full Name',
    form_user_username: 'Login Username',
    ...
    part_created_success: 'Part added and QR Code generated successfully!',
    part_updated_success: 'Part details updated successfully.',
    part_disabled_success: 'Part deactivated successfully.',
    user_created_success: 'User created successfully.',
    scan_success: 'Part successfully recognized!',
    ...
    confirm_disable: 'Are you sure you want to disable this part? (Historical transactions are preserved)',
    stock_added_success: 'Stock successfully added and transaction recorded!',
    stock_issued_success: 'Stock successfully issued and inventory updated!',
